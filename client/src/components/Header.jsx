...
const Header = () => {
    ...
    return (
        ...
        >
            ...
            <motion.h1 className='text-4xl max-w-[300px] sm:text-7xl sm:max-w-[570px] mx-auto mt-10 text-center'
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
            ...
            <motion.button className='sm:text-lg text-white bg-black w-auto mt-8 px-12 py-2.5 flex item-center 
            gap-2 rounded-full'
            ...
            <motion.div
                ...
                {Array(6).fill('').map((item, index) => (
                    <motion.img
                        ...
                        className='rounded hove:scale-105 transition-all duration-300 cursor-pointer max-sm:w-10'
